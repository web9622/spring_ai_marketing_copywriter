...
import com.spring_ai_hanbit.openai.model.ProductInfo;
...
public class MarketingController {
    ...
    public String getMarketing() {
        return "marketing-request"; // View name to be rendered
    }
    ...
    public String postMarketing(ProductInfo productInfo, Model model) {
        ...
        return "marketing-response"; // View name to be rendered
    }
}
